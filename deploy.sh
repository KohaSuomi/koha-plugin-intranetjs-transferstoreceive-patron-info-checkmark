...
PM_FILE="Koha/Plugin/Fi/KohaSuomi/TransferstoreceivePatronInfoCheckmark.pm"
...
if [ "$CURRENT_BRANCH" == "master" ]; then
    ...
    RELEASE_FILE="koha-plugin-intranetjs-transferstoreceive-patron-info-checkmark-v${VERSION}.kpz"
else
